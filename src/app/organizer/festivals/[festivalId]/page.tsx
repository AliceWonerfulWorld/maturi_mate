  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-gray-100 to-stone-100">
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 py-6 space-y-6 pb-32">
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
          <CardContent className="p-6 text-center">
            <Link href={`/organizer/festivals/${festivalId}/tasks/register`} >
...
const OrganizerTaskCard = memo(function OrganizerTaskCard({ task }: { task: OrganizerTask }) {
  return (
    <Card className="group hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm border border-slate-100">
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start">
          <CardTitle className="text-base font-bold text-gray-800 group-hover:text-slate-600 transition-colors">
            {task.title}
          </CardTitle>
          <Badge 
